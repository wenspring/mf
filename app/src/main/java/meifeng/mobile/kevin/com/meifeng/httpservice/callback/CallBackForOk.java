package meifeng.mobile.kevin.com.meifeng.httpservice.callback;
...
public abstract class CallBackForOk<T> {

    public static Handler mMainHandler = new Handler(Looper.getMainLooper());

    public Type mType;

    public CallBackForOk() {
     ...
     * 解析response，执行在子线程
     */
    public T onParseResponse(Call call, Response response) {
        return null;
    }
    ...
    public static abstract class CallBackDefault extends CallBackForOk<Response> {
        @Override
    ...
    public static abstract class CallBackString extends CallBackForOk<String> {
        @Override
    ...
    public static abstract class CallBackBitmap extends CallBackForOk<Bitmap> {
     ...
     * 下载文件时的回调类
     */
    public static abstract class CallBackFile extends CallBackForOk<File> {
