...
import meifeng.mobile.kevin.com.meifeng.httpservice.HttpClients;
...
class RequestUtil {
    ...
    private CallBackForOk mCallBack;//回调接口
    ...
    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackForOk callBack) {
        this(methodType, url, null, null, null, null, null, null, paramsMap, headerMap, callBack);
    }

    RequestUtil(String methodType, String url, String jsonStr, Map<String, String> headerMap, CallBackForOk callBack) {
        this(methodType, url, jsonStr, null, null, null, null, null, null, headerMap, callBack);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, File file, String fileKey, String fileType, Map<String, String> headerMap, CallBackForOk callBack) {
        this(methodType, url, null, file, null, fileKey, null, fileType, paramsMap, headerMap, callBack);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, List<File> fileList, String fileKey, String fileType, Map<String, String> headerMap, CallBackForOk callBack) {
        this(methodType, url, null, null, fileList, fileKey, null, fileType, paramsMap, headerMap, callBack);
    }

    RequestUtil(String methodType, String url, Map<String, String> paramsMap, Map<String, File> fileMap, String fileType, Map<String, String> headerMap, CallBackForOk callBack) {
        this(methodType, url, null, null, null, null, fileMap, fileType, paramsMap, headerMap, callBack);
    }

    private RequestUtil(String methodType, String url, String jsonStr, File file, List<File> fileList, String fileKey, Map<String, File> fileMap, String fileType, Map<String, String> paramsMap, Map<String, String> headerMap, CallBackForOk callBack) {
        ...
        L.pintOkHttpLog(mUrl, mParamsMap, mJsonStr, mHeaderMap);
    ...
    private void getInstance() {
        //mOkHttpClient = HttpClients.getInstance(SelfApplication.getContext()).getDefaultOkClient();
        ...
        // 可以把token添加到这儿 -- header
        //mRequestBuilder.addHeader(Fields.STRING_REQUEST_Authorization,Fields.STRING_REQUEST_TOKEN_prefix + SelfApplication.user.getUserToken());
    ...
    private RequestBody getRequestBody() {
        ...
        if (mParamsMap != null) {
            for (String key : mParamsMap.keySet()) {
                if (!UtilsMethod.isEmptyString(mParamsMap.get(key))) {
        ...
        mOkHttpClient.newCall(mOkHttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(final Call call, final Response response) throws IOException {
                if (mCallBack != null) {
                    ...
                    L.printOKHttpRes(string);
                    if (response.code() >= 400 && response.code() <= 599) {
                        try {
                            //mCallBack.onError(call, new RuntimeException(response.body().string()));
                            mCallBack.onFailure(call, new RuntimeException(string));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        return;
                    ...
                    if (mCallBack.mType == String.class) {
                        mCallBack.onResponse(string);
                        //mCallBack.onSeccess(call,response);
                    } else if (mCallBack.mType == Response.class) {
                        mCallBack.onResponse(response);
                        //mCallBack.onSeccess(call,response);
                    } else {
                        try {
                            Object obj = getGson().fromJson(string, mCallBack.mType);
    ...
    private static class ProgressRequestBody extends RequestBody {
        ...
        private CallBackForOk callBack;

        ProgressRequestBody(RequestBody requestBody, CallBackForOk callBack) {
        ...
        private Sink sink(BufferedSink sink) {
            return new ForwardingSink(sink) {
                ...
                public void write(Buffer source, long byteCount) throws IOException {
                    ...
                    CallBackForOk.mMainHandler.post(new Runnable() {
                        @Override
                        public void run() {
